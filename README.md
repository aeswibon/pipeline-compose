...
**Stable release:** **v1.10.0** — GitHub App cross-repo auth, stage catalog, plus v1.4 smart rerun, sub-pipelines, and typed context.
...
```yaml
- uses: aeswibon/pipeline-compose-run@v1.10.0
  with:
