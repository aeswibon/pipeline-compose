...
**Entry:** [`.github/workflows/release.yml`](../../.github/workflows/release.yml) runs `aeswibon/pipeline-compose-run@v1.8.0` with `pipeline_file: .github/pipelines/pipeline.yml`.
...
pnpm run validate .github/pipelines/pipeline.yml \
  ...
  --github '{"ref":"refs/tags/v1.8.0","event_name":"push"}'
```
